...
-- AddForeignKey
ALTER TABLE `ct_bitacora_accion` ADD CONSTRAINT `FK_ct_bitacora_accion_ct_usuario_in` FOREIGN KEY (`id_ct_usuario_in`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `ct_bitacora_accion` ADD CONSTRAINT `FK_ct_bitacora_accion_ct_usuario_up` FOREIGN KEY (`id_ct_usuario_up`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `ct_bitacora_entidad` ADD CONSTRAINT `FK_ct_bitacora_entidad_ct_usuario_in` FOREIGN KEY (`id_ct_usuario_in`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `ct_bitacora_entidad` ADD CONSTRAINT `FK_ct_bitacora_entidad_ct_usuario_up` FOREIGN KEY (`id_ct_usuario_up`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `ct_capitulo` ADD CONSTRAINT `FK_ct_capitulo_ct_usuario_in` FOREIGN KEY (`id_ct_usuario_in`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `ct_capitulo` ADD CONSTRAINT `FK_ct_capitulo_ct_usuario_up` FOREIGN KEY (`id_ct_usuario_up`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `ct_consumible_factura` ADD CONSTRAINT `FK_ct_consumible_factura_ct_usuario` FOREIGN KEY (`id_ct_usuario_in`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `ct_consumible_factura` ADD CONSTRAINT `FK_ct_consumible_factura_ct_usuario_2` FOREIGN KEY (`id_ct_usuario_up`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `ct_consumible_proveedor` ADD CONSTRAINT `FK_ct_consumibles_proveedor_ct_usuario` FOREIGN KEY (`id_ct_usuario_in`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `ct_consumible_proveedor` ADD CONSTRAINT `FK_ct_consumibles_proveedor_ct_usuario_2` FOREIGN KEY (`id_ct_usuario_up`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `ct_correspondencia_estado` ADD CONSTRAINT `FK_ct_correspondencia_estado_ct_usuario` FOREIGN KEY (`id_ct_usuario_in`) REFERENCES `ct_usuario`(`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `ct_partida` ADD CONSTRAINT `FK_ct_partida_ct_capitulo` FOREIGN KEY (`ct_capitulo_id`) REFERENCES `ct_capitulo`(`id_ct_capitulo`) ON DELETE RESTRICT ON UPDATE RESTRICT;

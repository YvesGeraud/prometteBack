...
CREATE TABLE `dt_correspondencia` (
    ...
    `id_ct_usuario_crea` INTEGER NOT NULL,
    `id_ct_usuario_modifica` INTEGER NULL,
    ...
    INDEX `fk_corresp_usuario_crea`(`id_ct_usuario_crea`),
    INDEX `fk_corresp_usuario_modifica`(`id_ct_usuario_modifica`),
...
CREATE TABLE `rl_analista_unidad` (
    `id_ct_puesto_unidad` INTEGER NOT NULL AUTO_INCREMENT,
    ...
    PRIMARY KEY (`id_ct_puesto_unidad`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `rl_correspondencia_usuario_estado` (
    ...
    `id_ct_usuario_puesto` INTEGER NOT NULL,
    ...
    INDEX `fk_rl_corresp_usuario_crea`(`id_ct_usuario_crea`),
    INDEX `fk_rl_corresp_usuario_puesto`(`id_ct_usuario_puesto`),
...
CREATE TABLE `rl_partida_area` (
    `id_ct_partida_area` INTEGER NOT NULL AUTO_INCREMENT,
    `id_area_infra` INTEGER NOT NULL DEFAULT 0,
    `id_ct_partida` INTEGER NOT NULL DEFAULT 0,
    `createdAt` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    `updatedAt` TIMESTAMP(0) NULL,
    ...
    PRIMARY KEY (`id_ct_partida_area`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `rl_producto_area` (
    `id_ct_producto_consumible_area` INTEGER NOT NULL AUTO_INCREMENT,
    ...
    PRIMARY KEY (`id_ct_producto_consumible_area`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `rl_producto_requisicion` (
    `id_ct_producto_consumible_requisicion` INTEGER NOT NULL AUTO_INCREMENT,
    `ct_area_id` INTEGER NOT NULL DEFAULT 0,
    ...
    PRIMARY KEY (`id_ct_producto_consumible_requisicion`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `rl_puesto_funcion` (
    `id_ct_puesto_funcion` INTEGER NOT NULL AUTO_INCREMENT,
    ...
    PRIMARY KEY (`id_ct_puesto_funcion`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `rl_usuario_funcion` (
    `id_ct_usuario_funcion` INTEGER NOT NULL AUTO_INCREMENT,
    `ct_usuario_id` INTEGER NULL,
    `dt_funcion_id` INTEGER NULL,
    `estado` BOOLEAN NOT NULL DEFAULT true,
    `ct_usuario_in` INTEGER NOT NULL,
    ...
    PRIMARY KEY (`id_ct_usuario_funcion`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `rl_usuario_puesto` (
    `id_ct_usuario_puesto` INTEGER NOT NULL AUTO_INCREMENT,
    `ct_usuario_id` INTEGER NOT NULL,
    ...
    PRIMARY KEY (`id_ct_usuario_puesto`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `dt_consumible_entrega` ADD CONSTRAINT `FK_dt_consumible_entrega_ct_unidad_medida` FOREIGN KEY (`ct_unidad_id`) REFERENCES `ct_unidad_medida`(`id_ct_unidad_medida`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `dt_consumible_entrega` ADD CONSTRAINT `FK_dt_consumible_entrega_ct_usuario` FOREIGN KEY (`ct_usuario_id`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `dt_consumible_inventario` ADD CONSTRAINT `FK_dt_inventario_ct_facturas` FOREIGN KEY (`ct_factura_id`) REFERENCES `ct_consumible_factura`(`id_ct_consumible_factura`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `dt_consumible_inventario` ADD CONSTRAINT `FK_dt_inventario_ct_partida` FOREIGN KEY (`ct_partida_id`) REFERENCES `ct_partida`(`id_ct_partida`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `dt_consumible_inventario` ADD CONSTRAINT `FK_dt_inventario_ct_unidad_medida` FOREIGN KEY (`ct_unidad_id`) REFERENCES `ct_unidad_medida`(`id_ct_unidad_medida`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `dt_correspondencia` ADD CONSTRAINT `fk_corresp_usuario_crea` FOREIGN KEY (`id_ct_usuario_crea`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `dt_diagnostico_aneec` ADD CONSTRAINT `fk_dt_diagnostico_aneec_creado_por` FOREIGN KEY (`ct_usuario_in`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `dt_funcion` ADD CONSTRAINT `fk_dt_funcion_actualizado_por` FOREIGN KEY (`ct_usuario_at`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `dt_funcion` ADD CONSTRAINT `fk_dt_funcion_creado_por` FOREIGN KEY (`ct_usuario_in`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `dt_informes_aneec` ADD CONSTRAINT `fk_dt_informes_annec_actualizado_por` FOREIGN KEY (`ct_usuario_at`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `dt_informes_aneec` ADD CONSTRAINT `fk_dt_informes_annec_creado_por` FOREIGN KEY (`ct_usuario_in`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `dt_planeaciones_aneec` ADD CONSTRAINT `FK_dt_planeaciones_aneec__actualizado_por` FOREIGN KEY (`ct_usuario_at`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `dt_techo_presupuesto` ADD CONSTRAINT `fk_techo_capitulo` FOREIGN KEY (`ct_capitulo_id`) REFERENCES `ct_capitulo`(`id_ct_capitulo`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `dt_techo_presupuesto` ADD CONSTRAINT `fk_techo_financiamiento` FOREIGN KEY (`ct_financiamiento_id`) REFERENCES `ct_financiamiento`(`id_ct_financiamiento`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `dt_techo_presupuesto` ADD CONSTRAINT `fk_techo_usuario_at` FOREIGN KEY (`ct_usuario_at`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `dt_techo_presupuesto` ADD CONSTRAINT `fk_techo_usuario_in` FOREIGN KEY (`ct_usuario_in`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `rl_analista_unidad` ADD CONSTRAINT `FK_rl_analista_unidad_ct_usuario` FOREIGN KEY (`ct_usuario_in`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `rl_area_financiero` ADD CONSTRAINT `fk_area_fin_usuario_at` FOREIGN KEY (`ct_usuario_at`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `rl_area_financiero` ADD CONSTRAINT `fk_area_fin_usuario_in` FOREIGN KEY (`ct_usuario_in`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `rl_correspondencia_usuario_estado` ADD CONSTRAINT `fk_rl_corresp_usuario_crea` FOREIGN KEY (`id_ct_usuario_crea`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `rl_correspondencia_usuario_estado` ADD CONSTRAINT `fk_rl_corresp_usuario_puesto` FOREIGN KEY (`id_ct_usuario_puesto`) REFERENCES `rl_usuario_puesto`(`id_ct_usuario_puesto`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `rl_entrega_formato` ADD CONSTRAINT `fk_rl_entrega_formato_ct_usuario` FOREIGN KEY (`ct_usuario_id`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `rl_justificacion` ADD CONSTRAINT `fk_justificacion_usuario` FOREIGN KEY (`ct_usuario_id`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `rl_producto_requisicion` ADD CONSTRAINT `FK__ct_producto_consumible` FOREIGN KEY (`ct_productos_id`) REFERENCES `ct_producto_consumible`(`id_ct_producto_consumible`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `rl_producto_requisicion` ADD CONSTRAINT `FK__ct_usuario` FOREIGN KEY (`ct_usuarios_in`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `rl_puesto_funcion` ADD CONSTRAINT `fk_rl_puesto_funcion_actualizado_por` FOREIGN KEY (`ct_usuario_at`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `rl_puesto_funcion` ADD CONSTRAINT `fk_rl_puesto_funcion_creado_por` FOREIGN KEY (`ct_usuario_in`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `rl_puesto_funcion` ADD CONSTRAINT `fk_rl_puesto_funcion_puesto` FOREIGN KEY (`ct_puesto_id`) REFERENCES `ct_puesto`(`id_ct_puesto`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `rl_usuario_funcion` ADD CONSTRAINT `fk_rl_usuario_funcion_actualizado_por` FOREIGN KEY (`ct_usuario_at`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `rl_usuario_funcion` ADD CONSTRAINT `fk_rl_usuario_funcion_creado_por` FOREIGN KEY (`ct_usuario_in`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `rl_usuario_funcion` ADD CONSTRAINT `fk_rl_usuario_funcion_usuario` FOREIGN KEY (`ct_usuario_id`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
-- AddForeignKey
ALTER TABLE `rl_usuario_puesto` ADD CONSTRAINT `fk_rl_usuario_puesto_ct_puesto` FOREIGN KEY (`ct_puesto_id`) REFERENCES `ct_puesto`(`id_ct_puesto`) ON DELETE RESTRICT ON UPDATE RESTRICT;

-- AddForeignKey
ALTER TABLE `rl_usuario_puesto` ADD CONSTRAINT `fk_rl_usuario_puesto_ct_usuario` FOREIGN KEY (`ct_usuario_id`) REFERENCES `ct_usuario`(`id_ct_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
